...
public class QpsBolt extends BaseRichBolt {
	 ...
	 * 
	 */
	private int rediskeyExpire = 86400;
	 ...
	 */
	public QpsBolt(HashMap<String, String> myConfigHashMap) {
		this.configHashMap = myConfigHashMap;
		this.redisAlarmQueueName = this.configHashMap.get("redis_alarm_queue_name_qps");
		this.rediskeyExpire = Integer.parseInt(this.configHashMap.get("redis_key_expire_qps"));	
	}	
	...
	public void execute(Tuple input) {
	    ...
	    if ((line.isEmpty()) || (line.equals("{}")))
	    	return;
	    this.jedis.incr("nums:qpsbolt:total:1");
